...
<table width="1025" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="264"><img src="images/sub_pic_09.jpg" width="264" height="157" /></td>
  ...
  <tr>
    <td width="218" valign="top" background="images/sub_left_11.png" bgcolor="#FFFFFF"><table width="218" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="168"><img src="images/rd_left_07.jpg" width="168" height="312" /></td>
      </tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="807" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="54" colspan="4" valign="bottom" background="images/sub_title_bg.jpg"> &nbsp;<img src="images/sub_title_10.png" width="220" height="25" /></td>
        </tr>
      <tr>
        <td width="49" height="520">&nbsp;</td>
        <td width="649" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="43">&nbsp;</td>
          </tr>
          <tr>
...
vo = getInfo.getContentInfoAction(14);
%>
            <td height="43">
			  <%=vo.getContent() %>
			</td>
