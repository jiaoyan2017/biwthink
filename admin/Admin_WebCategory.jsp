...
<html><head><title>网站信息类别管理<%=Action %></title>
...
<table width='100%' border='0' align='center' cellpadding='2' cellspacing='1' class='border'>
  <form name='searchmyform' action='Admin_WebCategory.jsp' method='get'>
  <tr class='tdbg'>
    <td height='30'>
        &nbsp;&nbsp;&nbsp;&nbsp;<a href='Admin_WebCategory.jsp'>网站信息类别管理首页</a>&nbsp;|&nbsp;<a href='Admin_WebCategory.jsp?Action=Add'>添加网站信息类别</a><%=Action %>
    </td>
  </tr>
  </form>
</table>
...
CategoryList = getCategoryList.getCategoryListAction(Keyword,pageView.getFromIndex(),pageView.getPageSize(),type);
 %>
    <table width='100%' border='0' cellpadding='0' cellspacing='0'>
      <tr>
      <form name='myform' method='Post' action='Admin_WebCategory.jsp'>
          <td>
          <table width='100%' border='0' align='center' cellpadding='2' cellspacing='1' class='border'>
        ...
        <tr><td colspan='20' height='50' align='center'>共找到 <font color=red><%=recordCount%></font> 个网站信息类别</td></tr>
  ...
  %>
                  <tr class='tdbg' onMouseOut="this.className='tdbg'" onMouseOver="this.className='tdbgmouseover'">
                    ...
                    <td width='509'><a href='Admin_WebCategory.jsp'><%=vo.getName() %></a></td>
                    <td><a href='Admin_WebCategory.jsp'><%=vo.getSummary() %></a></td>
                  
                    <td width='168' align='center'>
          
            <a href='Admin_WebCategory.jsp?Action=Modify&id=<%=vo.getId() %>&type=<%=type%>'>修改</a>&nbsp;
            <a href='Admin_WebCategory.jsp?Action=del&id=<%=vo.getId() %>' onClick='return confirm("确定要删除此网站信息类别吗？");'>删除</a>                    </td>
                  </tr>
<%} %>
              ...
              <table width='100%' border='0' cellpadding='0' cellspacing='0'>
                <tr height='30'>
                  ...
                  <input name='Del' type='submit' value=' 批量删除 ' onClick="document.myform.Action.value='DelAll';return confirm('确定要删除选定的网站信息类别吗？');">
                  &nbsp;&nbsp;&nbsp;&nbsp;
                 
                </tr>
              </table>
              
              <a href=Admin_WebCategory.jsp?Action=Main&pages=<%=pageView.getCurrentPage()-1 %>&type=<%=type%>&Keyword=<%=Keyword%>>上一页</a>  共<%=pageView.getPageSize() %>页  第<%=pageView.getCurrentPage() %>页 <a href=Admin_WebCategory.jsp?Action=Main&pages=<%=pageView.getCurrentPage()+1 %>&type=<%=type%>&Keyword=<%=Keyword%>>下一页</a>
          </td>
      </form>
      </tr>
    </table>
    ...
    <br>
    <form name='SearchForm' action='Admin_WebCategory.jsp' method='post'>
    <table width='100%'  border='0' align='center' cellpadding='1' cellspacing='1' class='border'>
      <tr class='tdbg'>
        <td width='113'><b>网站信息类别查询：</b></td>
        <td width="1198">
...
<%if("Add".equals(Action)){%>
    <br><table width='100%'><tr><td align='left'>您现在的位置：<a href='Admin_WebCategory.jsp'>网站信息类别管理</a>&nbsp;&gt;&gt;&nbsp;添加网站信息类别</td></tr></table>
    <form name='myform' id='myform' action='Admin_WebCategory.jsp' method='post' onSubmit='return CheckSubmit();'>
            ...
            <tr class='tdbg'>
                <td height='100' valign='top'>
                    <table width='95%' align='center' cellpadding='2' cellspacing='1' bgcolor='#FFFFFF' id='Tabs' style='display:'>
                        <tr class='tdbg'>
                            <td class='tdbg5' align='right'  width='12%'>网站信息类别名称：</td>
    ...
    <table width='100%' height='40'><tr align='center'><td><input type='hidden' name='type' value='<%=type%>'>
        ...
        <input type='submit' name='Submit' value='保存网站信息类别信息'>
    </td></tr></table>
    </form>
...
%>
    <br><table width='100%'><tr><td align='left'>您现在的位置：<a href='Admin_WebCategory.jsp'>网站信息类别管理</a>&nbsp;&gt;&gt;&nbsp;修改网站信息类别信息</td></tr></table>
    <form name='myform' id='myform' action='Admin_WebCategory.jsp' method='post' onSubmit='return CheckSubmit();'>
    <table width='100%'  border='0' align='center' cellpadding='5' cellspacing='1' class='border'>
            <tr class='tdbg'>
                <td height='100' valign='top'>
...
String   pic  = s.trimStr(request.getParameter("pic"));
	 ...
	 int status = tCategoryAction.insertCategoryAction(vo);
	  response.sendRedirect("Admin_WebCategory.jsp?Action=Main&type=2 ");
