...
<body bgcolor="#FFFFFF" onload="MM_preloadImages('images/menu_01b.png','images/menu_04b.png','images/menu_05b.png','images/menu_02b.png','images/menu_03b.png')">
    ...
    <td width="585" valign="top" bgcolor="#FFFFFF"><table width="585" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="585" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="95"><img src="images/menu_04a.png" width="95" height="38" /></td>
...
<table width="1025" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="264"><img src="images/sub_pic_07.jpg" width="264" height="157" /></td>
...
<table width="1025" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="218" valign="top" background="images/sub_left_11.png" bgcolor="#FFFFFF"><table width="218" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="3"><img src="images/ser_left_01.jpg" width="218" height="54" /></td>
        </tr>
      <tr>
        ...
        <td width="168"><img src="images/rd_left_02.jpg" width="168" height="312" /></td>
      </tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="807" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="54" colspan="4" valign="bottom" background="images/sub_title_bg.jpg"> &nbsp;<img src="images/sub_title_06.png" width="220" height="25" /></td>
        </tr>
      <tr>
...
vo = getInfo.getContentInfoAction(15);
%>
            <td height="43">
			 <%=vo.getContent() %>
              </td>
