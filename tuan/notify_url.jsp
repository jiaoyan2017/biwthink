...
TransactionAction action = new TransactionAction();
	...
	int flag = action.getTransactionInfoByOrderNoAction(out_trade_no);
	...
	if(true){//验证成功
		...
		if(trade_status.equals("WAIT_BUYER_PAY")){
			//该判断表示买家已在支付宝交易管理中产生了交易记录，但没有付款
				...
				vo.setFlag(1);
				if(flag==0){
					action.updateTransactionFlagAction(vo);
				}
			...
			//该判断表示买家已在支付宝交易管理中产生了交易记录且付款成功，但卖家没有发货
				...
				action.updateProductCountAction(vo);//更新商品数量
				
		//物流公司名称
		String logistics_name = "宇通物流";//request.getParameter("logistics_name");
		...
		out.println(sHtmlText);
			...
			//该判断表示卖家已经发了货，但买家还没有做确认收货的操作
				...
				if(flag==2){
					...
					//必填参数//
		//支付宝交易号
		//String trade_no = "2012060357903156";//request.getParameter("trade_no");
		
				
				
				
				
				//System.out.println("WAIT_BUYER_CONFIRM_GOODS");
			...
			//发短信
				...
				if(flag==3){
					action.updateTransactionFlagAction(vo);
					//action.sendMsgAction(out_trade_no);
				}
