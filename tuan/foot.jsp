...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" background="images/lt_tabbg.gif">
  ...
  <tr>
    ...
    <td width="806" align="right" valign="top" bgcolor="#FFFFFF"><table width="90%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        <td height="20"><div align="right" class="STYLE11">本网版权归河青传媒有限责任公司所有，转载请注明来源　冀ICP备09022655号　 </div></td>
      </tr>
      <tr>
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F032d28c10cd053e7b2af756a8dc5e7cc' type='text/javascript'%3E%3C/script%3E"));
</script>
