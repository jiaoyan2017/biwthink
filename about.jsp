...
<body bgcolor="#FFFFFF" onload="MM_preloadImages('images/menu_03b.png','images/menu_04b.png','images/menu_05b.png','images/menu_01b.png')">
...
<table width="1025" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="218" valign="top" background="images/sub_left_11.png" bgcolor="#FFFFFF"><table width="218" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><img src="images/sub_lefttitle_01a.png" width="168" height="28" /></td>
      </tr>
      <tr>
        <td><a href="vision.jsp"><img src="images/sub_lefttitle_02.png" width="168" height="30" border="0" /></a></td>
      </tr>
      <tr>
        <td><a href="Mission.jsp"><img src="images/sub_lefttitle_03.png" width="168" height="29" border="0" /></a></td>
      </tr>
      <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="807" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="54" colspan="4" valign="bottom" background="images/sub_title_bg.jpg"><img src="images/sub_title_01.png" width="180" height="25" /></td>
        </tr>
      <tr>
...
vo = getInfo.getContentInfoAction(9);
%>
            <td height="43"><span class="STYLE2">
			  <%=vo.getContent() %>
        ...
        <td width="238" valign="top"><table width="238" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><img src="images/sub_ill_01.jpg" width="238" height="280" /></td>
          </tr>
        </table></td>
