...
.STYLE5 {color: #828384; line-height: 21px; font-family: "微软雅黑";}
.STYLE6 {font-size: 16}
...
<table width="1025" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="218" valign="top" background="images/sub_left_11.png" bgcolor="#FFFFFF"><table width="218" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="168"><img src="images/sub_lefttitle_04a.png" width="168" height="29" /></td>
      </tr>
      <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="807" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="54" colspan="3" valign="bottom" background="images/sub_title_bg.jpg"><img src="images/sub_title_04.png" width="220" height="25" /></td>
        </tr>
      <tr>
...
vo = getInfo.getContentInfoAction(12);
%>

            <td height="43"><p class="STYLE2"><%=vo.getContent() %>
            </p></td>
          </tr>
          <tr>
            <td height="40">&nbsp;</td>
          ...
          <tr>
            <td height="40"><div align="right"><img src="images/sub_ill_04.jpg" width="710" height="206" /></div></td>
          </tr>
        </table></td>
